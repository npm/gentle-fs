...
test('readLinkOrShim', function (t) {
  ...
  var gentlyRm = requireInject('../../lib/rm.js', mocks)
...
test('isEverInside', function (t) {
  ...
  isEverInside('/path/to/file', ['/path/to', '/path/to/invalid'], log, function (er, inside) {
    t.ifError(er)
    pathIsDeeply(t, inside, {target: '/path/to/file', path: '/path/to'}, 'bad paths are ignored if something matches')
  })

  isEverInside('/path/to/invalid', ['/path/to/invalid'], log, function (er, inside) {
    t.is(er && er.code, 'EINVAL', 'errors bubble out')
  })

  isEverInside('/path/to/file', ['/ten'], log, function (er, inside) {
    t.ifError(er)
    t.is(inside, false, 'not inside')
  })
  isEverInside('/path/to/nowhere', ['/ten'], log, function (er, inside) {
    t.ifError(er)
    t.is(inside, false, 'missing target')
  })

  isEverInside('/path/to/file', ['/path/to'], log, function (er, inside) {
    t.ifError(er)
    pathIsDeeply(t, inside, {target: '/path/to/file', path: '/path/to'}, 'plain file in plain path')
  })
  isEverInside('/path/other/link', ['/path/to'], log, function (er, inside) {
    t.ifError(er)
    pathIsDeeply(t, inside, {target: '/path/to/file', path: '/path/to'}, 'link in plain path')
  })

  isEverInside('/path/to/file', ['/linkpath'], log, function (er, inside) {
    t.ifError(er)
    pathIsDeeply(t, inside, {target: '/path/to/file', path: '/path/to'}, 'plain file in link path')
  })
  isEverInside('/path/other/link', ['/linkpath'], log, function (er, inside) {
    t.ifError(er)
...
test('isSafeToRm', function (t) {
  ...
  function testIsSafeToRm (t, parent, target, shouldPath, shouldBase, msg) {
    isSafeToRm(parent, target, pkgName, log, function (er, path, base) {
  ...
  function testNotIsSafeToRm (t, parent, target, msg) {
    isSafeToRm(parent, target, pkgName, log, function (er) {
